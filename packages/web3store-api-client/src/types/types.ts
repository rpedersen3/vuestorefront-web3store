...
export type ProductAssetSortInput = {
  id?: SortEnum;
  price?: SortEnum;
};
...
export type Products = {
  ...
  assetAttributeValues: AttributeValue[];
  facets: Facet[];
}
...
export type GraphQlGetProductAssets = {
  productId: number;
};
...
export type GraphQlGetProductAssetParams = {
  slug: string;
};
...
export type GraphQlGetProductsParams = {
