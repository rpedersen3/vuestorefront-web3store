...
async function createServer(config: MiddlewareConfig): Promise<Express> {
  ...
  consola.info('(Rich) .... Loading integrations ...');
  ...
  app.post('/:integrationName/:functionName', async (req: Request, res: Response) => {
    ...
    consola.info('(Rich) .... Loading integration ' + integrationName + ' ...');
    ...
    consola.info('(Rich) .... createApiClient graphqlBaseUrl: ' + configuration.graphqlBaseUrl + ' ...');
    consola.info('(Rich) .... function name: ' + functionName + ' ...');
