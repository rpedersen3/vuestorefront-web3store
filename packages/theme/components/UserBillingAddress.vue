<template>
  <div>
    <p :style="userBillingAddress.isDefault ? 'font-weight: bold;' : ''">
      {{ userBillingAddress.firstName }} {{ userBillingAddress.lastName }}
    </p>
    <p>
      {{ userBillingAddress.street }}, {{ userBillingAddress.streetNumber }}
    </p>
...
import { userBillingGetters } from '@vue-storefront/web3store';
export default {
